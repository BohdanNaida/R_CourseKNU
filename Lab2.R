## ---------- 1 ----------
## Створить вектор v із 100 елементів командою v <- rnorm(100). Для цього вектору виведіть:
##10-й елемент;
...
v <- rnorm(100)
  ...
  print(v[v > 0])
  ## ---------- 2 ----------
  ## Створити фрейм (data frame) y командою
  ##y <- data.frame(a = rnorm(100), b = 1:100, cc = sample(letters, 100, replace = TRUE)). Для цього data frame виведіть:
  ##останні 10 строк; 
  ...
  y <- data.frame(a = rnorm(100), b = 1:100, cc = sample(letters, 100, replace = TRUE))
    ...
    print(y[,'cc'])
    ## ---------- 3 ----------
    ## Створити вектор z з елементами 1, 2, 3, NA, 4, NA, 5, NA. Для цього вектору:
